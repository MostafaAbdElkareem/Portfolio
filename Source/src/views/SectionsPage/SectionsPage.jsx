...
import SectionQualifications from './Sections/SectionQualifications.jsx';
...
class SectionsPage extends React.Component {
	...
	render() {
		...
		return (
			<div>
				<Header color="info" brand="Desha" links={<HeaderLinks dropdownHoverColor="info" />} fixed />
				<div className={classes.main}>
					<SectionAbout id="headers" />
					<SectionProjects id="projects" />
					<SectionWork id="work" />
					<SectionQualifications id="features" />
