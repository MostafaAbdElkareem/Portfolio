									...
									<Card testimonial plain className={classes.card2}>
										...
										<CardBody plain>
											<h5 className={classes.cardDescription}>
												...
												I gotta say at that time I’d like to meet Kanye I speak yell scream
												directly at the old guard on behalf of the future. My brother Chance!!!
												<br />
									...
									<Card testimonial plain className={classes.card2}>
										...
										<CardBody plain>
											<h5 className={classes.cardDescription}>
												...
												I Miss the Old Kanye At the God's last game Chop up the soul Kanye. I
												promise I will never let the people down. I want a better life for
