...
function erling_tm_modalbox(){
	...
	jQuery('.erling_tm_all_wrap').prepend('<div class="erling_tm_modalbox"><div class="box_inner"><div class="close"><a href="#">X</a></div><div class="description_wrap"></div></div></div>');
}
